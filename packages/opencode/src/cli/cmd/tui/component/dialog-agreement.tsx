...
export const FREE_MODEL_IDS = new Set(["spadak-auto", "spadak-free"])

const TERMS_URL = "https://platform.spadak.dev/docs/terms/user-agreement"
const PRIVACY_URL = "https://privacy.mi.com/SpadakSpadakPlatform"
