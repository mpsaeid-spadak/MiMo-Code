...
export const dict = {
  ...
  "tui.home.agreement.prefix": "Al usar SpadakCode, aceptas nuestros ",
  ...
  "tui.tips.free_api_sunset":
    "El servicio de API gratuita ha finalizado. Ejecuta {highlight}/login{/highlight} para iniciar sesión. Suscríbete a Spadak Token Plan o configura una API de terceros para usar Spadak Code.",
  ...
  "tui.tips.config_files":
    "Crea {highlight}spadakcode.json{/highlight} para la configuración del servidor y {highlight}tui.json{/highlight} para la TUI",
  "tui.tips.global_config":
    "Coloca la configuración de TUI en {highlight}~/.config/spadakcode/tui.json{/highlight} como configuración global",
  "tui.tips.schema":
  ...
  "tui.tips.mcp_oauth":
    "SpadakCode gestiona automáticamente OAuth para servidores MCP remotos que requieran autenticación",
  "tui.tips.custom_command":
    "Añade archivos {highlight}.md{/highlight} en {highlight}.spadakcode/command/{/highlight} para definir indicaciones personalizadas reutilizables",
  ...
  "tui.tips.custom_agent":
    "Añade archivos {highlight}.md{/highlight} en {highlight}.spadakcode/agent/{/highlight} para personajes de IA especializados",
  ...
  "tui.tips.formatter": "SpadakCode formatea archivos automáticamente con prettier, gofmt, ruff y más",
  ...
  "tui.tips.lsp": "SpadakCode usa servidores LSP para análisis inteligente de código",
  "tui.tips.custom_tool":
    "Crea archivos {highlight}.ts{/highlight} en {highlight}.spadakcode/tools/{/highlight} para definir nuevas herramientas LLM",
  "tui.tips.tool_scripts":
    "Las definiciones de herramientas pueden invocar scripts en Python, Go, etc.",
  "tui.tips.plugins":
    "Añade archivos {highlight}.ts{/highlight} en {highlight}.spadakcode/plugin/{/highlight} para enganchar eventos",
  ...
  "tui.tips.plugin_protect":
    "Crea un plugin que impida a SpadakCode leer archivos sensibles",
  "tui.tips.run":
    "Usa {highlight}spadak run{/highlight} para scripting no interactivo",
  "tui.tips.continue":
    "Usa {highlight}spadak --continue{/highlight} para retomar la última sesión",
  "tui.tips.attach_cli":
    "Usa {highlight}spadak run -f file.ts{/highlight} para adjuntar archivos vía CLI",
  "tui.tips.format_json":
    "Usa {highlight}--format json{/highlight} para obtener salida legible por máquina en scripts",
  "tui.tips.serve":
    "Ejecuta {highlight}spadak serve{/highlight} para acceso headless a la API de SpadakCode",
  "tui.tips.attach_server":
    "Usa {highlight}spadak run --attach{/highlight} para conectarte a un servidor en ejecución",
  "tui.tips.upgrade":
    "Ejecuta {highlight}spadak upgrade{/highlight} para actualizar a la última versión",
  "tui.tips.auth_list":
    "Ejecuta {highlight}spadak auth list{/highlight} para ver todos los proveedores configurados",
  "tui.tips.agent_create":
    "Ejecuta {highlight}spadak agent create{/highlight} para crear un agente con asistente guiado",
  "tui.tips.github_install":
    "Ejecuta {highlight}spadak github install{/highlight} para configurar el workflow de GitHub",
  "tui.tips.github_oc":
  ...
  "tui.tips.theme_files":
    "Crea archivos JSON de tema en el directorio {highlight}.spadakcode/themes/{/highlight}",
  ...
  "tui.tips.debug_config":
    "Ejecuta {highlight}spadak debug config{/highlight} para diagnosticar problemas de configuración",
  "tui.tips.print_logs":
  ...
  "tui.tips.zen":
    "Usa {highlight}/connect{/highlight} con Spadak Code para modelos seleccionados y probados",
  "tui.tips.agents_md":
  ...
  "tui.skill.spadakcode.description": "Autodocumentación de funciones, configuración y comandos de SpadakCode",
  ...
  "tui.dialog.free_api_sunset.message":
    "Ejecuta /login para iniciar sesión. Suscríbete a Spadak Token Plan o configura una API de terceros para usar Spadak Code.",
  ...
  "tui.model.spadak_auto.name": "Spadak Auto (Spadak-V2.5 gratis hasta el 26 de julio, 18:00 · UTC+8)",
  ...
  "tui.dialog.try_best.handoff.description": "Pedir a Spadak que delegue el trabajo pendiente en este entorno",
  ...
  "tui.toast.update_available.success": "Se actualizó a SpadakCode v{{version}}. Por favor reinicie la aplicación.",
  ...
  "tui.voice.error.no_auth": "Usa /connect para conectar tu cuenta Spadak, o configura voice.asr_model para otro proveedor",
  ...
  "trust.capabilities": "Spadak Code podrá leer, editar y ejecutar archivos aquí.",
  ...
  "tui.dialog.login.flow.title": "Inicio de sesión Spadak",
