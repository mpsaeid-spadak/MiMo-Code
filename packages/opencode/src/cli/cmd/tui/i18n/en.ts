export const dict: Record<string, string> = {
  ...
  "tui.home.agreement.prefix": "By using SpadakCode, you agree to our ",
  ...
  "tui.tips.free_api_sunset":
    "The free API service has ended. Run {highlight}/login{/highlight} to sign in. Subscribe to the Spadak Token Plan or configure a third-party API to use Spadak Code.",
  ...
  "tui.tips.config_files":
    "Create {highlight}spadakcode.json{/highlight} for server settings and {highlight}tui.json{/highlight} for TUI settings",
  "tui.tips.global_config": "Place TUI settings in {highlight}~/.config/spadakcode/tui.json{/highlight} for global config",
  ...
  "tui.tips.mcp_oauth": "SpadakCode auto-handles OAuth for remote MCP servers requiring auth",
  "tui.tips.custom_command":
    "Add {highlight}.md{/highlight} files to {highlight}.spadakcode/command/{/highlight} to define reusable custom prompts",
  ...
  "tui.tips.custom_agent":
    "Add {highlight}.md{/highlight} files to {highlight}.spadakcode/agent/{/highlight} for specialized AI personas",
  ...
  "tui.tips.formatter": "SpadakCode auto-formats files using prettier, gofmt, ruff, and more",
  ...
  "tui.tips.lsp": "SpadakCode uses LSP servers for intelligent code analysis",
  "tui.tips.custom_tool":
    "Create {highlight}.ts{/highlight} files in {highlight}.spadakcode/tools/{/highlight} to define new LLM tools",
  "tui.tips.tool_scripts": "Tool definitions can invoke scripts written in Python, Go, etc",
  "tui.tips.plugins":
    "Add {highlight}.ts{/highlight} files to {highlight}.spadakcode/plugin/{/highlight} for event hooks",
  "tui.tips.plugin_notify": "Use plugins to send OS notifications when sessions complete",
  "tui.tips.plugin_protect": "Create a plugin to prevent SpadakCode from reading sensitive files",
  "tui.tips.run": "Use {highlight}spadak run{/highlight} for non-interactive scripting",
  "tui.tips.continue": "Use {highlight}spadak --continue{/highlight} to resume the last session",
  "tui.tips.attach_cli": "Use {highlight}spadak run -f file.ts{/highlight} to attach files via CLI",
  "tui.tips.format_json": "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "tui.tips.serve": "Run {highlight}spadak serve{/highlight} for headless API access to SpadakCode",
  "tui.tips.attach_server": "Use {highlight}spadak run --attach{/highlight} to connect to a running server",
  "tui.tips.upgrade": "Run {highlight}spadak upgrade{/highlight} to update to the latest version",
  "tui.tips.auth_list": "Run {highlight}spadak auth list{/highlight} to see all configured providers",
  "tui.tips.agent_create": "Run {highlight}spadak agent create{/highlight} for guided agent creation",
  "tui.tips.github_install": "Run {highlight}spadak github install{/highlight} to set up the GitHub workflow",
  ...
  "tui.tips.theme_files": "Create JSON theme files in {highlight}.spadakcode/themes/{/highlight} directory",
  ...
  "tui.tips.debug_config": "Run {highlight}spadak debug config{/highlight} to troubleshoot configuration",
  ...
  "tui.tips.zen": "Use {highlight}/connect{/highlight} with Spadak Code for curated, tested models",
  ...
  "tui.skill.spadakcode.description": "Self-documentation for SpadakCode features, config, and commands",
  ...
  "tui.context_limit.scalar_config": "compaction.max_context is set to a single value for all models — edit it in spadakcode.json to switch to per-model limits",
  "tui.context_limit.shadowed": "Saved, but another config still forces {{value}} — check your project spadakcode.json",
  ...
  "tui.dialog.free_api_sunset.message":
    "Run /login to sign in. Subscribe to the Spadak Token Plan or configure a third-party API to use Spadak Code.",
  ...
  "tui.model.spadak_auto.name": "Spadak Auto (Spadak-V2.5 free until Jul 26, 18:00 · UTC+8)",
  ...
  "tui.dialog.try_best.handoff.description": "Ask Spadak to delegate the unfinished work to this harness",
  ...
  "tui.toast.update_available.success": "Successfully updated to SpadakCode v{{version}}. Please restart the application.",
  ...
  "tui.voice.error.no_auth": "Use /connect to sign in to Spadak, or configure voice.asr_model for another provider",
  ...
  "tui.dialog.login.spadak": "Spadak",
  "tui.dialog.login.spadak.desc": "(Recommended)",
  "tui.dialog.login.spadak_free": "Spadak Auto (free)",
  "tui.dialog.login.spadak_free.desc": "Anonymous free channel — no login required",
  "tui.dialog.login.spadak_free.success": "Spadak Auto (free) is ready — default model set to spadak/spadak-auto",
  "tui.dialog.login.spadak_free.unavailable": "Spadak Auto (free) provider not loaded",
  "cli.providers.select": "Select provider",
  "cli.providers.other": "Other provider",
  "cli.providers.spadak.recommended_hint": "recommended",
  "cli.providers.spadak_free.hint": "Anonymous free channel / spadak-auto",
  "cli.providers.spadak_free.verifying": "Verifying Spadak Auto (free) channel...",
  "cli.providers.spadak_free.ready": "Spadak Auto (free) channel ready",
  "cli.providers.spadak_free.failed": "Spadak Auto (free) verification failed",
  "cli.providers.spadak_free.default_set": "Default model set to spadak/spadak-auto (1M context, free)",
  "cli.providers.spadak_free.usage_hint": "No login required — just run spadak. For paid/premium models, choose Spadak browser login instead.",
  "cli.providers.spadak_login.decrypt_retry": "Decryption failed, please retry ({remaining} attempts left)",
  "cli.providers.spadak_login.decrypt_exhausted": "Decryption failed, max retries reached",
  ...
  "tui.dialog.login.flow.title": "Spadak Login",
  ...
  "trust.capabilities": "Spadak Code will be able to read, edit, and execute files here.",
  ...
  "skip_permissions.body":
    "You started with --dangerously-skip-permissions. Spadak Code will read, edit, and execute files and run shell commands WITHOUT asking for approval. Only rules you have explicitly denied in config are still enforced. You are solely responsible for anything it does.",
