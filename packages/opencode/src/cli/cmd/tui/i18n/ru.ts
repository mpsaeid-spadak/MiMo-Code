...
export const dict = {
  ...
  "tui.home.agreement.prefix": "Используя SpadakCode, вы соглашаетесь с нашими ",
  ...
  "tui.tips.free_api_sunset":
    "Сервис бесплатного API завершён. Выполните {highlight}/login{/highlight}, чтобы войти. Оформите подписку на Spadak Token Plan или настройте сторонний API для использования Spadak Code.",
  ...
  "tui.tips.config_files":
    "Создайте {highlight}spadakcode.json{/highlight} для серверных настроек и {highlight}tui.json{/highlight} для настроек TUI",
  "tui.tips.global_config":
    "Поместите настройки TUI в {highlight}~/.config/spadakcode/tui.json{/highlight} как глобальные",
  "tui.tips.schema":
  ...
  "tui.tips.mcp_oauth":
    "SpadakCode автоматически обрабатывает OAuth для удалённых MCP-серверов с авторизацией",
  "tui.tips.custom_command":
    "Добавляйте файлы {highlight}.md{/highlight} в {highlight}.spadakcode/command/{/highlight} для повторно используемых пользовательских команд",
  ...
  "tui.tips.custom_agent":
    "Добавляйте файлы {highlight}.md{/highlight} в {highlight}.spadakcode/agent/{/highlight} для специализированных AI-персон",
  ...
  "tui.tips.formatter":
    "SpadakCode автоматически форматирует файлы с помощью prettier, gofmt, ruff и других инструментов",
  ...
  "tui.tips.lsp": "SpadakCode использует LSP-серверы для интеллектуального анализа кода",
  "tui.tips.custom_tool":
    "Создавайте файлы {highlight}.ts{/highlight} в {highlight}.spadakcode/tools/{/highlight}, чтобы определить новые LLM-инструменты",
  "tui.tips.tool_scripts":
    "Определения инструментов могут вызывать скрипты на Python, Go и других языках",
  "tui.tips.plugins":
    "Добавляйте файлы {highlight}.ts{/highlight} в {highlight}.spadakcode/plugin/{/highlight} для подключения хуков событий",
  ...
  "tui.tips.plugin_protect":
    "Создайте плагин, который запретит SpadakCode читать чувствительные файлы",
  "tui.tips.run":
    "Используйте {highlight}spadak run{/highlight} для неинтерактивных скриптов",
  "tui.tips.continue":
    "Используйте {highlight}spadak --continue{/highlight}, чтобы продолжить последнюю сессию",
  "tui.tips.attach_cli":
    "Используйте {highlight}spadak run -f file.ts{/highlight}, чтобы прикрепить файлы из командной строки",
  "tui.tips.format_json":
    "Используйте {highlight}--format json{/highlight} для машинно-читаемого вывода в скриптах",
  "tui.tips.serve":
    "Запустите {highlight}spadak serve{/highlight} для headless-доступа к API SpadakCode",
  "tui.tips.attach_server":
    "Используйте {highlight}spadak run --attach{/highlight}, чтобы подключиться к запущенному серверу",
  "tui.tips.upgrade":
    "Выполните {highlight}spadak upgrade{/highlight}, чтобы обновиться до последней версии",
  "tui.tips.auth_list":
    "Выполните {highlight}spadak auth list{/highlight}, чтобы увидеть всех настроенных провайдеров",
  "tui.tips.agent_create":
    "Выполните {highlight}spadak agent create{/highlight}, чтобы создать агента в пошаговом режиме",
  "tui.tips.github_install":
    "Выполните {highlight}spadak github install{/highlight}, чтобы настроить GitHub-workflow",
  "tui.tips.github_oc":
  ...
  "tui.tips.theme_files":
    "Создавайте JSON-файлы тем в каталоге {highlight}.spadakcode/themes/{/highlight}",
  ...
  "tui.tips.debug_config":
    "Выполните {highlight}spadak debug config{/highlight}, чтобы диагностировать проблемы конфигурации",
  "tui.tips.print_logs":
  ...
  "tui.tips.zen":
    "Используйте {highlight}/connect{/highlight} с Spadak Code для подобранных и протестированных моделей",
  "tui.tips.agents_md":
  ...
  "tui.skill.spadakcode.description": "Самодокументация функций, конфигурации и команд SpadakCode",
  ...
  "tui.dialog.free_api_sunset.message":
    "Выполните /login, чтобы войти. Оформите подписку на Spadak Token Plan или настройте сторонний API для использования Spadak Code.",
  ...
  "tui.model.spadak_auto.name": "Spadak Auto (Spadak-V2.5 бесплатно до 26 июля, 18:00 · UTC+8)",
  ...
  "tui.dialog.try_best.handoff.description": "Попросить Spadak поручить незавершённую работу этому исполнителю",
  ...
  "tui.toast.update_available.success": "Обновлено до SpadakCode v{{version}}. Пожалуйста, перезапустите приложение.",
  ...
  "tui.voice.error.no_auth": "Используйте /connect для подключения к Spadak или настройте voice.asr_model для другого провайдера",
  ...
  "tui.dialog.login.spadak_free.desc": "Анонимный бесплатный канал — вход не требуется",
  "tui.dialog.login.spadak_free.success": "Spadak Auto (free) готов — модель по умолчанию: spadak/spadak-auto",
  "tui.dialog.login.spadak_free.unavailable": "Провайдер Spadak Auto (free) не загружен",
  "tui.dialog.login.flow.title": "Вход в Spadak",
  ...
  "cli.providers.spadak.recommended_hint": "рекомендуется",
  "cli.providers.spadak_free.hint": "Анонимный бесплатный канал / spadak-auto",
  "cli.providers.spadak_free.verifying": "Проверка канала Spadak Auto (free)...",
  "cli.providers.spadak_free.ready": "Канал Spadak Auto (free) готов",
  "cli.providers.spadak_free.failed": "Не удалось проверить Spadak Auto (free)",
  "cli.providers.spadak_free.default_set": "Модель по умолчанию: spadak/spadak-auto (контекст 1M, бесплатно)",
  "cli.providers.spadak_free.usage_hint":
    "Вход не требуется — просто запустите spadak. Для платных/премиум-моделей выберите вход через браузер Spadak.",
  "cli.providers.spadak_login.decrypt_retry": "Ошибка расшифровки, повторите попытку (осталось попыток: {remaining})",
  "cli.providers.spadak_login.decrypt_exhausted": "Ошибка расшифровки, превышено максимальное число попыток",
  ...
  "trust.capabilities": "Spadak Code сможет читать, редактировать и выполнять файлы здесь.",
  ...
  "skip_permissions.body":
    "Вы запустили с --dangerously-skip-permissions. Spadak Code будет читать, редактировать и выполнять файлы, а также запускать команды оболочки БЕЗ запроса подтверждения. Действуют только правила, которые вы явно запретили (deny) в конфигурации. Вы несёте полную ответственность за все его действия.",
