...
function pagerCmd(): string[] {
  ...
  if (Flag.SPADAKCODE_GIT_BASH_PATH) {
    const less = path.join(Flag.SPADAKCODE_GIT_BASH_PATH, "..", "..", "usr", "bin", "less.exe")
...
export const SessionImportClaudeCommand = cmd({
  ...
  describe: "import Claude Code sessions (~/.claude/projects) into spadakcode",
  builder: (yargs: Argv) =>
    yargs.option("force", {
