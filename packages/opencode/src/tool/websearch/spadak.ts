...
const DEFAULT_BASE_URL = "https://api.spadak.dev/v1"

export const QUOTA_EXCEEDED =
  "Web search quota exhausted (free tier limit reached). Top up or manage your plan at https://platform.spadak.dev/console/plugin, or use `webfetch` with a relevant URL instead."
