...
export function createTextNgramMonitor() {
  return new TextNgramMonitor(
    Flag.SPADAKCODE_TEXT_NGRAM_N,
    Flag.SPADAKCODE_TEXT_REPEAT_THRESHOLD,
    Flag.SPADAKCODE_TEXT_WINDOW_TOKENS,
  )
}
...
REPETITION DETECTED: Your recent output contains repeated phrases (sliding n-gram match within your last ${Flag.SPADAKCODE_TEXT_WINDOW_TOKENS} tokens).
