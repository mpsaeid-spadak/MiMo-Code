import { Effect, Deferred, Context, Fiber, Layer, Scope, Cause, Schedule, Exit } from "effect"
 ...
 * TODO: lift to spadakcode.json config (e.g. actor.maxPreReact) and add per-hook
  ...
  Effect.gen(function* () {
    ...
    const forkWork = (input: {
      ...
      Effect.gen(function* () {
        ...
        // ignored: not reachable in normal usage (spadak run sets no such rule, spawn doesn't
