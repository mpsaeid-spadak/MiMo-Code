  ...
  JSON.stringify(
    {
      name: pkg.name,
      version: version,
      description: "Spadak Code: Where Models and Agents Co-Evolve",
      license: "MIT",
      ...
      bugs: {
        url: "https://github.com/SpadakSpadak/Spadak-Code/issues",
      },
      keywords: ["ai", "cli", "code", "spadak", "spadak", "spadakcode"],
      bin: {
        spadak: "./bin/spadak",
      },
      scripts: {
