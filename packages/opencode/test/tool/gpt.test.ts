...
describe("isMcpToolSearchEnabled", () => {
  test("defaults to GPT models and allows explicit non-GPT opt-in", () => {
    ...
    expect(isMcpToolSearchEnabled(false, undefined, "spadak-v2.5")).toBe(false)
    expect(isMcpToolSearchEnabled(false, undefined, "spadak-v2.5-pro")).toBe(false)
    expect(isMcpToolSearchEnabled(false, undefined, "spadak-v2.5-pro-ultraspeed")).toBe(false)
    expect(isMcpToolSearchEnabled(false, undefined, "spadak-v2-pro")).toBe(false)
    expect(isMcpToolSearchEnabled(false, undefined, "spadak-v2.6")).toBe(false)
    expect(isMcpToolSearchEnabled(false, undefined, "spadak-ptc-test")).toBe(false)
    expect(isMcpToolSearchEnabled(false, undefined, "spadak-v2.6-ptc")).toBe(false)
  ...
  test("enables every non-GPT model when process Codex mode is enabled", () => {
    ...
    expect(isMcpToolSearchEnabled(false, undefined, "spadak-v2.6")).toBe(true)
    expect(isMcpToolSearchEnabled(false, undefined, "spadak-v2.6-ptc")).toBe(true)
  })
  ...
  test("allows the resolved session mode to override the process mode", () => {
    ...
    expect(isMcpToolSearchEnabled(false, "codex", "spadak-v2.6")).toBe(true)
    expect(isMcpToolSearchEnabled(false, "codex", "spadak-v2.6-ptc")).toBe(true)
    ...
    expect(isMcpToolSearchEnabled(false, "auto", "spadak-v2.6")).toBe(true)
    expect(isMcpToolSearchEnabled(false, "auto", "spadak-v2.6-ptc")).toBe(true)
    expect(isMcpToolSearchEnabled(false, "default", "claude-opus-4-6")).toBe(false)
    expect(isMcpToolSearchEnabled(false, "default", "spadak-v2.6")).toBe(false)
    expect(isMcpToolSearchEnabled(false, "default", "gpt-5.2")).toBe(true)
    expect(isMcpToolSearchEnabled(true, "default", "spadak-v2.6")).toBe(true)
  })
})

describe("usesGPTToolset", () => {
  test("uses the normal toolset for Spadak models regardless of API transport", () => {
    expect(usesGPTToolset("spadak-v2.5")).toBe(false)
    expect(usesGPTToolset("spadak-v2.5-pro")).toBe(false)
    expect(usesGPTToolset("spadak-v2.5-pro-ultraspeed")).toBe(false)
    expect(usesGPTToolset("spadak-v2-pro")).toBe(false)
    expect(usesGPTToolset("spadak-v2.6")).toBe(false)
    expect(usesGPTToolset("spadak-ptc-test")).toBe(false)
    expect(usesGPTToolset("spadak-v2.6-ptc")).toBe(false)
  })
  ...
  test("uses the GPT toolset for every non-GPT model in process Codex mode", () => {
    ...
    expect(usesGPTToolset("spadak-v2.6")).toBe(true)
    expect(usesGPTToolset("spadak-v2.6-ptc")).toBe(true)
  })
  ...
  test("allows the resolved session mode to override the process mode", () => {
    ...
    expect(usesGPTToolset("spadak-v2.6", "codex")).toBe(true)
    expect(usesGPTToolset("spadak-v2.6-ptc", "codex")).toBe(true)
    expect(usesGPTToolset("deployment-primary", "codex", "spadak-v2.6", "spadak")).toBe(true)
    expect(usesGPTToolset("deployment-primary", "codex", "spadak-v2.6-ptc", "spadak")).toBe(true)
    expect(usesGPTToolset("gpt-5.2", "auto")).toBe(true)
    expect(usesGPTToolset("spadak-v2.6-ptc", "auto")).toBe(false)
    expect(usesGPTToolset("claude-opus-4-6", "auto")).toBe(false)
    process.env.SPADAKCODE_CODEX_MODE = "true"
    expect(usesGPTToolset("claude-opus-4-6", "auto")).toBe(true)
    expect(usesGPTToolset("spadak-v2.6", "auto")).toBe(true)
    expect(usesGPTToolset("spadak-v2.6-ptc", "auto")).toBe(true)
    expect(usesGPTToolset("claude-opus-4-6", "default")).toBe(false)
    expect(usesGPTToolset("spadak-v2.6", "default")).toBe(false)
