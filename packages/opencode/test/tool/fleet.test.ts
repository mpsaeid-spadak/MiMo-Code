...
describe("assembleFleet", () => {
  test("correlates liveness, turn telemetry, and worktree mapping into grouped rows", () => {
    ...
    const worktrees: WorktreeEntry[] = [
      { directory: "/wt/a", branch: "spadakcode/port-parser", ahead: 3 },
      { directory: "/wt/b", branch: "spadakcode/billing", ahead: 0 },
    ]
    ...
    expect(a.branch).toBe("spadakcode/port-parser")
...
describe("renderFleetTable", () => {
  ...
  test("renders grouped headings, worktree cell, and summary line", () => {
    ...
    const worktrees: WorktreeEntry[] = [{ directory: "/wt/a", branch: "spadakcode/port-parser", ahead: 3 }]
    ...
    expect(out).toContain("spadakcode/port-parser (+3) @ /wt/a")
