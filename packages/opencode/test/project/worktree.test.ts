      ...
      provideTmpdirInstance(
        () =>
          Effect.gen(function* () {
            ...
            expect(info.branch).toBe(`spadakcode/${info.name}`)
      ...
      provideTmpdirInstance(
        () =>
          Effect.gen(function* () {
            ...
            expect(info.branch).toBe("spadakcode/my-feature")
          }),
        { git: true, outsideGit: true },
      ),
    )
      ...
      provideTmpdirInstance(
        () =>
          Effect.gen(function* () {
            ...
            expect(info.name).toBeDefined()
            expect(info.branch).toStartWith("spadakcode/")
      ...
      provideTmpdirInstance(
        () =>
          Effect.gen(function* () {
            ...
            expect(info.branch).toBe("spadakcode/test-workspace")
