...
const experimental = Flag.SPADAKCODE_EXPERIMENTAL_WORKSPACES

Flag.SPADAKCODE_EXPERIMENTAL_WORKSPACES = true
...
afterAll(() => {
  ...
  Flag.SPADAKCODE_EXPERIMENTAL_WORKSPACES = experimental
})
