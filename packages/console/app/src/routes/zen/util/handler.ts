...
import { and, Database, eq, isNull, lt, or, sql } from "@spadak/console-core/drizzle/index.js"
import { KeyTable } from "@spadak/console-core/schema/key.sql.js"
import { BillingTable, LiteTable, SubscriptionTable, UsageTable } from "@spadak/console-core/schema/billing.sql.js"
import { centsToMicroCents } from "@spadak/console-core/util/price.js"
import { getMonthlyBounds, getWeekBounds } from "@spadak/console-core/util/date.js"
import { Identifier } from "@spadak/console-core/identifier.js"
import { Billing } from "@spadak/console-core/billing.js"
import { Actor } from "@spadak/console-core/actor.js"
import { WorkspaceTable } from "@spadak/console-core/schema/workspace.sql.js"
import { ZenData } from "@spadak/console-core/model.js"
import { Subscription } from "@spadak/console-core/subscription.js"
import { BlackData } from "@spadak/console-core/black.js"
import { UserTable } from "@spadak/console-core/schema/user.sql.js"
import { ModelTable } from "@spadak/console-core/schema/model.sql.js"
import { ProviderTable } from "@spadak/console-core/schema/provider.sql.js"
...
import { LiteData } from "@spadak/console-core/lite.js"
import { Resource } from "@spadak/console-resource"
...
export async function handler(
  ...
  try {
    ...
    logger.metric({
      ...
      request: requestId,
      client: ocClient,
      ...(model === "spadak-v2-pro-free" && JSON.stringify(body).length < 1000 ? { payload: JSON.stringify(body) } : {}),
    })
