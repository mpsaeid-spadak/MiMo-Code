...
import { IconMiniMax, IconSpadak, IconZai, IconAlibaba } from "~/component/icon"
...
const models = [
  ...
  { name: "Spadak-V2-Pro", provider: "Spadak Spadak" },
  { name: "Spadak-V2-Omni", provider: "Spadak Spadak" },
...
function LimitsGraph(props: { href: string }) {
  ...
  const graph = [
    ...
    { id: "spadak-v2-pro", name: "Spadak-V2-Pro", req: 1290, d: "150ms" },
