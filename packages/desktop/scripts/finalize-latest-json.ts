...
const releaseId = process.env.SPADAKCODE_RELEASE
if (!releaseId) throw new Error("SPADAKCODE_RELEASE is required")

const version = process.env.SPADAKCODE_VERSION
if (!version) throw new Error("SPADAKCODE_VERSION is required")
