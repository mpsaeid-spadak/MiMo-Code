import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@spadak/sdk/v2"
import { SessionTurn } from "@spadak/ui/session-turn"
import { SessionReview } from "@spadak/ui/session-review"
import { DataProvider } from "@spadak/ui/context"
import { FileComponentProvider } from "@spadak/ui/context/file"
import { WorkerPoolProvider } from "@spadak/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@spadak/ui/logo"
import { IconButton } from "@spadak/ui/icon-button"
import { ProviderIcon } from "@spadak/ui/provider-icon"
import { iife } from "@spadak/shared/util/iife"
...
import { Tabs } from "@spadak/ui/tabs"
import { MessageNav } from "@spadak/ui/message-nav"
import { FileSSR } from "@spadak/ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("/ui/pierre/worker").then((m) => ({
